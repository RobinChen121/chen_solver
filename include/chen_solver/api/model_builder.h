 ...
 * Created on: 2026/8/20, 22:16
 * Description: provide a modeling interface for users to build models in a more convenient way,
 * similar to Gurobi.
 *
 */
...
namespace chen_solver {
    ...
    public:
        LinExpr() = default;
        explicit LinExpr(const Var &var) : terms_{{.col = var.col(), .coef = 1.0}} {
        }
